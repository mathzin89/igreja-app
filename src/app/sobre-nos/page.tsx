  ...
  return (
    <Box sx={{ backgroundColor: '#fff', py: 6 }}>
      <Container maxWidth="lg">
        ...
        <Divider sx={{ mb: 6 }} />
        <Box sx={{ my: 5 }}>
          <Typography textAlign="center" variant="h4" component="h2" gutterBottom sx={{ fontFamily: 'var(--font-merriweather)', color: '#333', }}>
            Nossa História
          </Typography>
          <Typography variant="body1" sx={{ fontSize: '1.1rem', lineHeight: 1.8, color: '#555' }}>
            O ministério Plenitude...
          </Typography>
        </Box>
            ...
            <Grid container spacing={4} justifyContent="center">
              <Grid item xs={12} sm={8} md={5}>
                <Card>
                  ...
                  <CardContent>
                    <Typography variant="h6">Josenildo Cassimiro & Maria Lucia</Typography>
              ...
              <Grid item xs={12} sm={8} md={5}>
               ...
               <CardMedia component="img" height="350" image="/images/pastor-delson.jpg" alt="Foto do Pastor Delson" />
                  <CardContent>
                    <Typography variant="h6">Delson</Typography>
              ...
              <Grid item xs={12} sm={8} md={5}>
                <Card>
                  ...
                  <CardContent>
                    <Typography variant="h6">Antônio</Typography>
                    <Typography variant="body2" color="text.secondary">Pastor</Typography>
                  </CardContent>
                </Card>
              </Grid>
          ...
          <TabPanel value={tabValue} index={1}>
            ...
            <Grid container spacing={4} justifyContent="center">
              <Grid item xs={12} sm={6} md={4}>
                <Card>
                  <CardMedia component="img" height="300" image="/images/casal-pastoral2.jpg" alt="Dirigentes" />
                  <CardContent>
                    <Typography variant="h6">Igor Henrique & Jéssica</Typography>
