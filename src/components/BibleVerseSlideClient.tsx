// src/components/BibleVerseSlideClient.tsx
'use client';

import React, { useState, useEffect, useCallback } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
// As interfaces BibleBook, ChapterContent e VerseContent estão definidas em '@/lib/bible'
import { BibleBook, ChapterContent, VerseContent } from '@/lib/bible'; 
...
export default function BibleVerseSlideClient({
  ...
  const chapter: ChapterContent | undefined = book.chapters[chapterIndex];

  // CORRIGIDO: totalVerses deve ser o length do array 'verses' dentro do capítulo
  const totalVerses = chapter ? chapter.verses.length : 0; 
  ...
  // CORRIGIDO: currentVerseText deve ser acessado do array 'verses' e pegar a propriedade 'text'
  const currentVerseText = chapter.verses[currentVerseIndex]?.text || '';
